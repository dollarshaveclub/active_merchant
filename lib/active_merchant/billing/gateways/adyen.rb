module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class AdyenGateway < Gateway
      ...
      class_attribute :test_token_url, :live_token_url
      self.test_token_url = 'https://pal-test.adyen.com/pal/servlet/Recurring/v18'
      self.live_token_url = 'https://pal-test.adyen.com/pal/servlet/Recurring/v18'
      ...
      def commit(action, parameters, url = default_url)
        begin
